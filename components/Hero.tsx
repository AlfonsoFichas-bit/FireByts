...
const Hero = () => {
  return (
    <section id="inicio" class="min-h-[70vh] grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-20">
      <div class="text-left">
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight">
          &gt; Creamos soluciones <br /> con <span class="text-accent-blue font-light">código.</span>
        </h1>
